...
*/
    public static void main(String[] args) {
        ...
        //student's grade must be in 0-100 range
        try {
            printGrades(45);
        ...
        //İnput name (name must initialize Upper case)
    ...
    public static void printGrades(double grade) throws IllegalGradeException {
        if (grade < 0 || grade > 100) {
            throw new IllegalGradeException("Grade connot be less than zero and more than hundred");
        } else {
